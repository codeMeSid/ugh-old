    ...
    return <MainLayout messages={messages}>
        <section className="signin" style={{ backgroundImage: `url(${LoginBg})` }}>
            <div className="signin__container">
                ...
                <Input placeholder="ugh id*" name="ughId" onChange={onChangeHandler} isWhite />
                <Input placeholder="password*" type="password" name="password" onChange={onChangeHandler} isWhite />
