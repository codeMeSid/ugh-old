    ...
    <div className="form__group">
      {image && progress === 100 ? (
        ...
        <div className="form__group">
          <label
            htmlFor={`${name}`}
            className="form__file__label"
            style={{ borderColor: isWhite ? "white" : "", ...style }}
          >
            <span className="form__file__label__icon">
              <AiOutlineFolderAdd style={{ color: isWhite ? "white" : "" }} />
            </span>
            <span
              className="form__file__label__text"
      ...
      <small
        className="form__file__placeholder"
        style={{ color: isWhite ? "white" : "" }}
      >
        {placeholder}
      </small>
